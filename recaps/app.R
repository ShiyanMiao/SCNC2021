...
<p>
QTL Design Sandbox is an interactive R Shiny application that allows users to simulate quantitative traits,
apply marker-selection models, and evaluate statistical power and false-discovery rate (FDR) under different experimental designs.
...
<h3>Background</h3>
<p>Marker-assisted selection (MAS) has greatly improved plant and animal breeding efficiency.
A key step is identifying genetic markers associated with traits of interest through quantitative trait loci (QTL) mapping.
However, the statistical power to detect these markers depends on factors such as:</p>
<ul>
  <li>sample size</li>
...
<p>This Shiny app provides a simulation-based teaching framework to explore these factors interactively
and to support optimal experimental design decisions.</p>
<hr />

<h2>Learning Goals</h2>
<ul>
  <li>Understand how sample size, heritability, and model choice influence power in QTL studies.</li>
  <li>Practise simulation and statistical modelling using R.</li>
  <li>Develop skills in reproducible research and visual analysis.</li>
</ul>
<hr />

<h2>App Structure and Main Functions</h2>
<ol>
  <li><b>Data Input Page</b> – Upload or load genotype data.</li>
  <li><b>Trait Simulation Page</b> – Simulate quantitative traits under user-defined QTL settings.</li>
  <li><b>Model Page</b> – Select and fit marker-selection models (single or multiple marker).</li>
  <li><b>Power Page</b> – Perform resampling-based power analysis across sample sizes.</li>
  <li><b>Output Page</b> – View and download summary results, plots, and tables.</li>
  <li><b>Readme or About Page</b> – Display project information and session details.</li>
</ol>
<hr />

<h2>Step-by-Step Teaching Guide</h2>

<h3>1. Data Input Page</h3>
<p><i>Purpose:</i> Provide genotype data for simulation and analysis.</p>
<p><i>Buttons and Actions:</i></p>
<ul>
  <li><b>Upload Data</b>: Select a local CSV containing genotype data (X matrix).</li>
  <li><b>Use Built-in Toy Data</b>: Loads the default dataset if no file is available.</li>
  <li><b>Preview Table</b>: Displays the first 10 rows to verify format.</li>
</ul>
<p><i>Why we do this:</i> Ensures the data matrix is correctly formatted and that users understand the input structure (individuals by markers).</p>
<hr />

<h3>2. Trait Simulation Page</h3>
<p><i>Purpose:</i> Generate a quantitative trait vector y based on the genotype matrix X.</p>
<p><i>Buttons and Actions:</i></p>
<ul>
  <li><b>Number of QTLs</b>: Choose how many markers truly affect the trait.</li>
  <li><b>Effect Size Distribution</b>: Set mean and variance of QTL effects.</li>
  <li><b>Heritability or PVE</b>: Control the percentage of trait variance explained by QTLs.</li>
  <li><b>Simulate Trait</b>: Runs the simulation function to generate phenotypes.</li>
</ul>
<p><i>Why we do this:</i> Trait simulation creates a known-truth dataset so users can test whether statistical models can correctly recover the true QTLs under different assumptions.</p>
<hr />

<h3>3. Model Page</h3>
<p><i>Purpose:</i> Fit marker-selection models and evaluate their performance.</p>
<p><i>Buttons and Actions:</i></p>
<ul>
  <li><b>Model Type</b>: Choose Single-Marker Regression or Multiple-Marker Model.</li>
  <li><b>Run Model</b>: Executes the selected model.</li>
  <li><b>Result Table</b>: Shows each marker’s estimate, p-value, LOD-value and LRT-value.</li>
</ul>
<p><i>Why we do this:</i> Comparing single versus multiple-marker models illustrates how model choice affects detection power and false-discovery rates.
FDR adjustment controls Type I error when many markers are tested.</p>
<hr />

<h3>4. Power Page</h3>
<p><i>Purpose:</i> Perform resampling-based power analysis over different sample sizes.</p>
<p><i>Buttons and Actions:</i></p>
<ul>
  <li><b>Sample Sizes</b>: Enter a range (for example, 50 to 500).</li>
  <li><b>Run Power Analysis</b>: Performs simulation and re-estimation for each sample size.</li>
  <li><b>Power Plot</b>: Displays the proportion of true QTLs detected versus sample size.</li>
  <li><b>FDR Plot</b>: Displays the false discovery rate versus sample size.</li>
</ul>
<p><i>Why we do this:</i> Power analysis helps determine how large a sample is required to achieve acceptable detection probability while controlling FDR.</p>
<p><i>Why bootstrap power can be smaller than bisection power:</i>
Bootstrap estimates the "empirical" detection rate under repeated resampling,  
while bisection (λ/NCP method) computes "theoretical" power under ideal assumptions.  
Because bootstrap reflects sampling variation, limited sample size, and noise,  
its estimated power may be slightly smaller.  
This difference is normal and shows how real data uncertainty affects detection probability.</p>
<hr />

<h3>5. Output Page</h3>
<p><i>Purpose:</i> Summarise and export results.</p>
<p><i>Buttons and Actions:</i></p>
<ul>
  <li><b>Summary Table</b>: Lists input parameters, detected markers, power, and FDR at each sample size.</li>
  <li><b>Download Results</b>: Exports tables as CSV or report as HTML.</li>
</ul>
<p><i>Why we do this:</i> Facilitates reporting and reproducibility; users can document and compare different simulation settings.</p>
...
server <- function(input, output, session) {                    # Main Shiny server function with I/O bindings
  ...
  fdr_curve_bootstrap <- function(dat,                                                         # Define function
    ...
    # NEW: add option for permutation-based FDR                                                # Note: permutation option added to avoid flat ~0 curves
