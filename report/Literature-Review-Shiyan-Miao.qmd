...
As shown in @fig-1, recombination between the marker locus and the putative QTL occurs with probability $c$, the recombination frequency. The resulting BC₁ progeny segregate into four possible genotypes:
...
![**Density plot showing an example of two-state Gaussian mixture distribution.** In the backcross experiemnt we demonstrated these two states corresponds to two hidden genotype of the QTL: Qq and qq.](Figure%202.png){#fig-2 fig-align="center" width=70%}
